        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Activities>(entity =>
            {
                entity.HasKey(e => e.ActivityId)
                    .HasName("PK__Activiti__45F4A7915D384BA1");
            ...
            modelBuilder.Entity<ActivityCategories>(entity =>
            {
                entity.HasKey(e => e.ActivityCategoryId)
                    .HasName("PK__Activity__71C78C653383B4B5");
            ...
            modelBuilder.Entity<ActivityStatuses>(entity =>
            {
                entity.HasKey(e => e.ActivityStatusId)
                    .HasName("PK__Activity__860CFEADE5623079");

                entity.HasIndex(e => e.ActivityStatusDescription, "UQ__Activity__732635EC80620DE3")
                    .IsUnique();
            ...
            modelBuilder.Entity<AlternateAddresses>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__Alternat__091C2AFB1D72BA0E");

                entity.HasIndex(e => e.fk_MemberId, "UQ__Alternat__3B54230C2E651C56")
                    .IsUnique();
            ...
            modelBuilder.Entity<Branches>(entity =>
            {
                entity.HasKey(e => e.BranchId)
                    .HasName("PK__Branches__A1682FC5F7CD1357");

                entity.HasIndex(e => e.BranchName, "UQ__Branches__3903DB039672FBC2")
                    .IsUnique();

                entity.HasIndex(e => e.BranchAddress, "UQ__Branches__F50DE17AA8178C40")
                    .IsUnique();
            ...
            modelBuilder.Entity<CustomizedOrders>(entity =>
            {
                entity.HasKey(e => e.Customized_Id)
                    .HasName("PK__Customiz__AFADABDDB6E36743");
            ...
            modelBuilder.Entity<Customized_materials>(entity =>
            {
                entity.HasKey(e => e.Shoesmaterial_Id)
                    .HasName("PK__Customiz__06EFE12D93912B10");
            ...
            modelBuilder.Entity<MembershipLevels>(entity =>
            {
                ...
                entity.HasMany(d => d.fk_Privilege)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("fk_LevelId", "fk_PrivilegeId").HasName("PK__Membersh__580C8EAA53E9BC74");
            ...
            modelBuilder.Entity<OneToOneReservations>(entity =>
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__OneToOne__B7EE5F24F80A12B9");
            ...
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__Reservat__B7EE5F24789E03E8");

                entity.HasIndex(e => e.ReservationStatusDescription, "UQ__Reservat__ADF40EA60509CB08")
                    .IsUnique();
            ...
            modelBuilder.Entity<ShoesCategories>(entity =>
            {
                entity.HasKey(e => e.ShoesCategoryId)
                    .HasName("PK__ShoesCat__A478678B7CB8D8DC");
            ...
            modelBuilder.Entity<ShoesColorCategories>(entity =>
            {
                entity.HasKey(e => e.ShoesColorId)
                    .HasName("PK__ShoesCol__BB1469D478344CEB");
            ...
            modelBuilder.Entity<ShoesPictures>(entity =>
            {
                entity.HasKey(e => e.ShoesPicture_Id)
                    .HasName("PK__ShoesPic__DF35EBA407EFFA55");
            ...
            modelBuilder.Entity<SpeakerFields>(entity =>
            {
                entity.HasKey(e => e.FieldId)
                    .HasName("PK__SpeakerF__C8B6FF07508A91F4");
            ...
            modelBuilder.Entity<Speakers>(entity =>
            {
                entity.HasKey(e => e.SpeakerId)
                    .HasName("PK__Speakers__79E757592BAE3159");
                ...
                entity.HasOne(d => d.fk_SpeakerField)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Speakers__fk_Spe__7FEAFD3E");
            });
            ...
            modelBuilder.Entity<Suppliers>(entity =>
            {
                entity.HasKey(e => e.SupplierId)
                    .HasName("PK__Supplier__4BE666B48D89E1BF");

                entity.HasIndex(e => e.SupplierCompanyNumber, "UQ__Supplier__AE8E9B414ECD7581")
                    .IsUnique();
